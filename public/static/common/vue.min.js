...
!(function (e, t) {
	...
	function dr(e, r) {
		var i = r.componentOptions;
		if (
			!((n(i) && !1 === i.Ctor.options.inheritAttrs) || (t(e.data.attrs) && t(r.data.attrs)))
		) {
			var o,
				a,
				s = r.elm,
	...
	function Br(e, t) {
		var n = (function (e) {
			if (
				((e = e.trim()), (gr = e.length), e.indexOf('[') < 0 || e.lastIndexOf(']') < gr - 1)
			)
	...
	var zi = (function (e) {
			...
			if (
				...
				!(function (e, t, i, o) {
					...
					if (n(a)) {
						...
						if (
							(n((a = a.hook)) && n((a = a.init)) && a(e, !1), n(e.componentInstance))
						)
							return (
								d(e, t),
								v(i, e.elm, o),
		...
		function O(e, t, i, o) {
			...
			if (
				n(c) &&
				(n((a = c.hook)) && n((a = a.init)) && a(t, !0), n((a = t.componentInstance)))
			)
				return d(t, i), !0;
			if (n(s)) {
				if (n(u))
					...
					if ('select' === o)
						!(function (e, t, n) {
							...
							(r =
								r +
								' ' +
								Br(t, '$event.target.multiple ? $$selectedVal : $$selectedVal[0]')),
