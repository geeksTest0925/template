			...
			23: [
				function (a, b, c) {
					...
					function e(a, b) {
						...
						if (c)
							return (
								(c.value = a.value && /^(rgb|hsl)/.test(a.value) ? a.value : 'rgb'),
								c
							);
					}
					function f(a) {
				...
				function (a, b, c) {
					b.exports = function (b) {
						...
						h.add('svg-gradient', function (a) {
							...
							return (
								(j +=
									'</' + p + 'Gradient><rect ' + q + ' fill="url(#g)" /></svg>'),
									...
									extend: function (a) {
										...
										if (q.$str(a ? '&:extend(' : ':extend(')) {
											do {
												...
												(f = f && f[1]),
													b ||
														j('Missing target selector for :extend().'),
					...
					(j.prototype = new e()),
						...
						(j.prototype.eval = function (a) {
							var b,
								...
								h = this.variable;
							'string' != typeof f &&
								((f = 1 === f.length && f[0] instanceof g ? f[0].value : d(a, f)),
								(h = !1)),
								'font' === f &&
									a.math === i.ALWAYS &&
					...
					(g.prototype = new d()),
						...
						(g.prototype.mixinElements = function () {
							...
							var a = this.elements
								...
								.match(/[,&#\*\.\w-]([\w-]|(\\.))*/g);
							return (
								a ? '&' === a[0] && a.shift() : (a = []), (this.mixinElements_ = a)
							);
						}),
