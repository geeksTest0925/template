...
const getRotationFromMat4 = (mat4) => {
    return new THREE.Matrix4().set(mat4.elements[0], mat4.elements[4], mat4.elements[8], 0, mat4.elements[1], mat4.elements[5], mat4.elements[9], 0, mat4.elements[2], mat4.elements[6], mat4.elements[10], 0, 0, 0, 0, 1);
};
...
const getQuaternionFromLookAt = (mat) => {
    let tempMatrix = new THREE.Matrix4().lookAt(new THREE.Vector3(), new THREE.Vector3(mat.elements[2], mat.elements[6], mat.elements[10]), new THREE.Vector3(mat.elements[1], mat.elements[5], mat.elements[9]));
...
const loadGLTFObj = (url, decode) => __awaiter$1(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => __awaiter$1(void 0, void 0, void 0, function* () {
...
const loadFBXObj = (url, decode) => __awaiter$1(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => __awaiter$1(void 0, void 0, void 0, function* () {
        const response = yield fetch(url);
...
const textureLoader = (url) => __awaiter$1(void 0, void 0, void 0, function* () {
...
const GLTFModelLoader = ({ url, meta = {}, forceLoad = false, click, decode = false }) => __awaiter(void 0, void 0, void 0, function* () {
...
const FBXModelLoader = ({ url, meta, forceLoad, click, decode = false }) => __awaiter(void 0, void 0, void 0, function* () {
...
class RaycasterHelper {
    ...
    static getCanvasRelativePosition(event, canvas) {
        ...
        return new PickPosition((event.clientX - rect.left) * canvas.scrollWidth / rect.width, (event.clientY - rect.top) * canvas.scrollHeight / rect.height);
    }
}
...
class Exporter {
    ...
    export(input, filename) {
        return new Promise(resolve => {
            this.exporter.parse(input, function (result) {
                let file;
