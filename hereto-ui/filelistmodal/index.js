...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ components_FileListModal; }
});
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/dist/index.js??ruleSet[1].rules[11].use[0]!./lib/components/FileListModal/index.vue?vue&type=script&setup=true&lang=js

const _withScopeId = n => ((0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.pushScopeId)("data-v-a05aa3a6"), n = n(), (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.popScopeId)(), n);
...
/* harmony default export */ var FileListModalvue_type_script_setup_true_lang_js = ({
  __name: 'index',
  props: {
    visible: {
      type: Boolean,
  ...
  setup(__props, {
    ...
    const pendingValue = (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.computed)({
      get: () => {
        return props.list.filter(item => {
          console.log(item.file.name, item.status);
          return item.status === 2;
        }).length;
      }
    });
    const failValue = (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.computed)({
      get: () => {
        return props.list.filter(item => item.status === -1).length;
      }
    });
    const closeSelf = e => {
    ...
    return (_ctx, _cache) => {
      const _component_a_tooltip = (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.resolveComponent)("a-tooltip");
      const _component_a_progress = (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.resolveComponent)("a-progress");
      const _component_h_table = (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.resolveComponent)("h-table");
      const _component_a_modal = (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.resolveComponent)("a-modal");
      return (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.openBlock)(), (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createBlock)(_component_a_modal, (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.mergeProps)({
        ...
        default: (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.withCtx)(() => [_hoisted_1, (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createElementVNode)("div", _hoisted_2, [(0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createElementVNode)("div", _hoisted_3, [(0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createTextVNode)(" 正在上传："), (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createElementVNode)("span", null, (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.toDisplayString)((0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.unref)(pendingValue)), 1)]), (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createElementVNode)("div", _hoisted_4, [(0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createTextVNode)(" 上传失败："), (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createElementVNode)("span", null, (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.toDisplayString)((0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.unref)(failValue)), 1)])]), (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createElementVNode)("div", _hoisted_5, [(0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createVNode)(_component_h_table, {
          columns: columns,
          "data-source": __props.list,
          pagination: false,
          scroll: __props.list.length > 6 ? {
            y: 400
          } : null,
          theme: "light"
        }, {
          bodyCell: (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.withCtx)(({
            ...
            record,
            index
          }) => [column.key === 'index' ? ((0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.openBlock)(), (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createElementBlock)(external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.Fragment, {
            key: 0
          }, [(0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createTextVNode)((0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.toDisplayString)(index + 1), 1)], 64)) : (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createCommentVNode)("", true), column.key === 'fileName' ? ((0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.openBlock)(), (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createBlock)(_component_a_tooltip, {
            key: 1
          }, {
            title: (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.withCtx)(() => [(0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createTextVNode)((0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.toDisplayString)(record.file.name), 1)]),
            default: (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.withCtx)(() => [(0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createElementVNode)("div", _hoisted_6, (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.toDisplayString)(record.file.name), 1)]),
            _: 2
          }, 1024)) : (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createCommentVNode)("", true), column.key === 'type' ? ((0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.openBlock)(), (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createElementBlock)("div", _hoisted_7, (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.toDisplayString)(getFileType(record.file.name)), 1)) : (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createCommentVNode)("", true), column.key === 'size' ? ((0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.openBlock)(), (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createElementBlock)("div", _hoisted_8, (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.toDisplayString)(formatSize(record.file.size)), 1)) : (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createCommentVNode)("", true), column.key === 'progress' ? ((0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.openBlock)(), (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createElementBlock)(external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.Fragment, {
            key: 4
          }, [record.status === -1 ? ((0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.openBlock)(), (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createElementBlock)("div", _hoisted_9, [(0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createVNode)(_component_a_progress, {
            percent: 100,
            status: "exception"
          }), (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createVNode)((0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.unref)(icons_DeleteOutlined), {
            class: "delete-icon",
            onClick: $event => handleRemove(record)
          }, null, 8, ["onClick"])])) : ((0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.openBlock)(), (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createBlock)(_component_a_progress, {
            key: 1,
            percent: record.percentage,
            status: record.percentage === 100 ? 'success' : 'active'
          }, null, 8, ["percent", "status"]))], 64)) : (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createCommentVNode)("", true)]),
          _: 1
...
;// CONCATENATED MODULE: ./lib/components/FileListModal/index.vue?vue&type=script&setup=true&lang=js
 
// EXTERNAL MODULE: ./node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(3744);
;// CONCATENATED MODULE: ./lib/components/FileListModal/index.vue
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.Z)(FileListModalvue_type_script_setup_true_lang_js, [['__scopeId',"data-v-a05aa3a6"]])

/* harmony default export */ var FileListModal = (__exports__);
;// CONCATENATED MODULE: ./lib/components/FileListModal/index.js

FileListModal.install = Vue => {
  Vue.component('h-file-list-modal', FileListModal);
};
/* harmony default export */ var components_FileListModal = (FileListModal);
}();
